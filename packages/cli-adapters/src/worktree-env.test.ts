 ...
 * the variables that matter. Jingler had been launched with
 * `pnpm --filter @jingler/desktop dev` from `/Users/dev/repos/jingler`, and
 * every one of these reached a session working in an unrelated worktree.
 */
const LEAKED = {
  HOME: "/Users/dev",
  PATH: [
    "/Users/dev/repos/jingler/apps/desktop/node_modules/.bin",
    "/Users/dev/repos/jingler/node_modules/.bin",
    "/opt/homebrew/bin",
    "/usr/bin"
  ].join(delimiter),
  NODE_PATH: "/Users/dev/Library/pnpm/global/5/.pnpm/pnpm@10.7.0/node_modules",
  PNPM_SCRIPT_SRC_DIR: "/Users/dev/repos/jingler/apps/desktop",
  npm_config_node_linker: "hoisted",
  npm_config_shamefully_hoist: "true",
  npm_config_registry: "https://registry.npmjs.org/",
  npm_lifecycle_event: "dev",
  npm_package_name: "@jingler/desktop",
  npm_execpath: "/Users/dev/Library/pnpm/global/5/.pnpm/pnpm@10.7.0/bin/pnpm.cjs"
}

const WORKTREE = "/Users/dev/jingler/worktrees/acme/feature"
...
describe("worktreeEnv", () => {
  ...
  it("drops the origin repo's .bin from PATH so its binaries cannot shadow the session's", () => {
    ...
    expect(entries).not.toContain("/Users/dev/repos/jingler/node_modules/.bin")
    expect(entries).not.toContain("/Users/dev/repos/jingler/apps/desktop/node_modules/.bin")
  })
   ...
   *
   * `resolve("")` is the process cwd — the checkout Jingler was launched from
