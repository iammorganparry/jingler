...
export const memoryPrompt = (): string =>
  [
    ...
    "Changes are durable proposals: use memory_propose with the accepted base revision, retain the returned workflow handle, and poll memory_workflow_status until it settles. Never claim a proposal is published merely because it was submitted.",
