...
export const welcomeSubject = "You're in — welcome to Jingler"
...
export function Welcome({ email, openUrl, quickstartUrl }: WelcomeProps) {
  return (
    ...
    >
      <H1>
        Welcome to Jingler <span style={{ color: color.accent }}>✦</span>
      </H1>
      <P style={{ margin: "0 0 20px" }}>
        Your account&apos;s live. Jingler runs your local coding agents — <Mono size="13px">claude</Mono>,{" "}
      ...
      <Step n={1}>Point Jingler at a repo — it reads your branch and open PR automatically.</Step>
      <Step n={2}>
      ...
      <Section style={{ marginTop: "12px" }}>
        <PrimaryButton href={openUrl}>Open Jingler</PrimaryButton>
      </Section>
...
Welcome.PreviewProps = {
  email: "you@acme.dev",
  openUrl: "https://app.jingler.dev/open",
  quickstartUrl: "https://docs.jingler.dev/quickstart"
